...
function calculateTotalSum() {
  ...
  if (EdocsApi.getAttributeValue("edocsDocSum").value != contractAmountSum) EdocsApi.setAttributeValue({ code: "edocsDocSum", value: contractAmountSum > 0 ? contractAmountSum : 0 });
}
/*
