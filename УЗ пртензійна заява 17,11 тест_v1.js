...
function calculateTotalSum() {
  ...
  if (!EdocsApi.getAttributeValue("ToCalculate").value) {
    EdocsApi.setAttributeValue({ code: "edocsDocSum", value: contractAmountSum });
    EdocsApi.setAttributeValue({ code: "ToCalculate", value: "1" });
  }
...
function onChangeInvoice_Claim_table() {
  ...
  if (table) {
    ...
    EdocsApi.setAttributeValue({ code: "AmountAccordingProvideDocuments", value: ClaimAmount3 + ClaimAmount2 });
  } else {
